...
class SeleniumAcceptanceTests(unittest.TestCase):
    ...
    def test_expenses_drilldown(self):
        ...
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/0/n/n/n/n/n", driver.current_url)
        ...
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/1/3/n/n/n/n", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/2/3/06/n/n/n", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/3/3/06/063/n/n", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/4/3/06/063/n/n", driver.current_url)
        self.assertEqual("0.6%", driver.find_element_by_id("hfp-percentage").text)
        self.assertEqual(u"Menntamál > Æskulýðs- og íþróttamál > Félagsmiðstöðvar", driver.find_element_by_css_selector("[id*=_subtitle]").text)
        # Slice "Vörukaup" clicked in sidebar
        driver.find_element_by_xpath("//div[@id='option4']/div[4]/span").click()
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/5/3/06/063/n/2000", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/6/3/06/063/n/2500", driver.current_url)
    ...
    def test_joint_revenues_drilldown(self):
        ...
        driver.find_element_by_id("menu-toggle").click()
        time.sleep(1)
        self.assertEqual(u"Gjöld, 2015", driver.find_element_by_css_selector("[id*=_title]").text)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/joint-revenue/2015-0/3/n/n/", driver.current_url)
        self.assertEqual("100.0%", driver.find_element_by_id("hfp-percentage").text)
        self.assertEqual("kr. 18.529.125.975.-", driver.find_element_by_xpath("//div[@id='hfp-progress']/p").text)
        self.assertEqual("Sameiginlegar tekjur, 2015", driver.find_element_by_css_selector("[id*=_title]").text)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/joint-revenue/2015-0/4/00-011/n/", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/joint-revenue/2015-0/5/00-011/0000/", driver.current_url)
        self.assertEqual("80.2%", driver.find_element_by_id("hfp-percentage").text)
        ...
        time.sleep(1)
        self.assertEqual("http://localhost:8000/#/joint-revenue/2015-0/6/00-011/0000/", driver.current_url)
        self.assertEqual("80.2%", driver.find_element_by_id("hfp-percentage").text)
        self.assertEqual(u"Útsvar > Tekjur", driver.find_element_by_css_selector("[id*=_subtitle]").text)
    ...
    def test_random_actions_trying_to_break(self):
        ...
        time.sleep(1)
        self.assertEqual(u"Gjöld, 2015 - febrúar", driver.find_element_by_css_selector("[id*=_title]").text)
        self.assertEqual("http://localhost:8000/#/expenses/2015-02/0/n/n/n/n/n", driver.current_url)
        ...
        time.sleep(1)
        self.assertEqual(u"Gjöld, 2015 - þriðji ársfjórðungur", driver.find_element_by_css_selector("[id*=_title]").text)
        self.assertEqual("http://localhost:8000/#/expenses/2015-3/0/n/n/n/n/n", driver.current_url)
        ...
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/1/6/n/n/n/n", driver.current_url)
        # Click the same slice again
        driver.find_element_by_xpath("//div[@id='option0']/div[4]/span").click()
        time.sleep(1)
        self.assertEqual("100.0%", driver.find_element_by_id("hfp-percentage").text)
        self.assertEqual("Allar deildir", driver.find_element_by_css_selector("[id*=_subtitle]").text)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/1/n/n/n/n/n", driver.current_url)
        # Go straight to primary finance keys
        driver.find_element_by_id("option-text2").click()
        time.sleep(1)
        self.assertEqual("100.0%", driver.find_element_by_id("hfp-percentage").text)
        self.assertEqual("Allar deildir", driver.find_element_by_css_selector("[id*=_subtitle]").text)
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/4/n/n/n/n/n", driver.current_url)
        ...
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/5/n/n/n/n/2000", driver.current_url)
        ...
        self.assertEqual("http://localhost:8000/#/expenses/2015-0/6/n/n/n/n/2900", driver.current_url)
        ...
        self.assertEqual("Allar deildir", driver.find_element_by_css_selector("[id*=_subtitle]").text)
        self.assertEqual(u"Sértekjur, 2015", driver.find_element_by_css_selector("[id*=_title]").text)
        self.assertEqual("http://localhost:8000/#/special-revenue/2015-0/0/n/n/n/n/n", driver.current_url)
        # Open help function
